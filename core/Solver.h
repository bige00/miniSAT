...
public:
    ...
    int     nClauses   ()      const;       // The current number of original clauses.for test in read function
    int     nLearnts   ()      const;       // The current number of learnt clauses.
    int     nVars      ()      const;       // The current number of variables.for test
    int     nFreeVars  ()      const;
